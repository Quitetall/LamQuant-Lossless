...
#[cfg(feature = "optimum-v2")]
use lamquant_lml_optimum_v2::{PeerCodec, PeerEncodeContext, PEER_MAX_VALUES};
...
#[cfg(feature = "optimum-v2")]
pub const OPTIMUM_V2_PEER_NODE_TYPE: &str = "org.quitetall.lamquant.lml.encode.optimum-v2-peer";
#[cfg(feature = "optimum-v2")]
...
#[cfg(feature = "optimum-v2")]
const OPTIMUM_V2_HOST_KERNEL: KernelId = KernelId(0x4c4d_0301);
#[cfg(feature = "optimum-v2")]
const OPTIMUM_V2_BLUT_KERNEL: KernelId = KernelId(0x4c4d_0303);
...
pub fn optimum_v2_peer_descriptor() -> NodeDescriptor {
    NodeDescriptor {
        ...
        resources: ResourceEnvelope::bounded(PEER_MAX_SIGNAL_BYTES, PEER_MAX_PACKET_BYTES, 1),
...
pub fn register_lml_nodes(registry: &mut KernelRegistry) -> Result<(), CompileError> {
    ...
    #[cfg(feature = "optimum-v2")]
    for (id, target) in [
        (OPTIMUM_V2_HOST_KERNEL, Target::Host),
        (OPTIMUM_V2_BLUT_KERNEL, Target::BlutDurable),
    ] {
...
fn optimum_v2_kernel(id: KernelId, target: Target) -> KernelDescriptor {
    KernelDescriptor {
        ...
        resources: ResourceEnvelope::bounded(PEER_MAX_SIGNAL_BYTES, PEER_MAX_PACKET_BYTES, 1),
        determinism: Determinism::BitExact,
        lowering: "fused:org.quitetall.lamquant.lml.encode.optimum-v2-peer:peer-v4".into(),
    }
}
