...
fn rust_round_trip_preserves_variants() {
    ...
    let cases: Vec<OpEvent> = vec![
        ...
        OpEvent::FileDone {
            ts_ms: 4, path: "p".into(), success: true, ms: 5,
            cr: Some(1.5), bytes_in: None, bytes_out: None,
            samples: None, duration_s: None, n_channels: None,
            sample_rate: None, sha256: None, n_windows: None,
        },
        OpEvent::FileDone {
            ts_ms: 5, path: "p".into(), success: false, ms: 0,
            cr: None, bytes_in: None, bytes_out: None,
            samples: None, duration_s: None, n_channels: None,
            sample_rate: None, sha256: None, n_windows: None,
        },
