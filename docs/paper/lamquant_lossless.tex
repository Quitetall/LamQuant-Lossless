...
spanning twelve clinical and research EEG datasets with zero
...
72{,}131 unique recordings spanning twelve clinical and research
...
Section~\ref{sec:results} spans twelve heterogeneous EEG datasets
...
spanning twelve clinical and research EEG datasets with zero failures. The codec is
