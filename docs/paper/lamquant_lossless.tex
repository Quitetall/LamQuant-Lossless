...
spanning the seven TUH EEG corpora and CHB-MIT with zero failures;
the per-operation count exceeds the unique recording count because
the labelled TUH subsets (TUSZ, TUAR, TUAB, TUSL, TUEV, TUEP)
re-list TUEG recordings under their respective label montages and
the codec was run independently against each sub-corpus. The codec is released
...
72{,}131 unique recordings spanning seven TUH EEG datasets and
CHB-MIT, bit-exact reconstruction was verified in every case.
