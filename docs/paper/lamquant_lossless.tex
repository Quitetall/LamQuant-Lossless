...
TUEG v2.0.1 & 1{,}760.07   & 769.68         & 2.287:1 \\
\midrule
...
\begin{table}[!t]
\renewcommand{\arraystretch}{1.3}
\caption{Per-Corpus Shannon Entropy on TUH + CHB-MIT
($n \approx 16.8 \times 10^9$ samples)}
...
CHB-MIT     & 200 & 8.387  & 6.724 & 1.908:1 & 2.379:1 \\
\midrule
\textbf{Weighted aggregate} & --- & \textbf{9.244} & \textbf{7.656} &
\textbf{1.731:1} & \textbf{2.090:1} \\
\bottomrule
\end{tabular}
\end{table}
